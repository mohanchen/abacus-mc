...
> **Note:** For ABACUS v3.9.0.25+, the matrices are stored in `hrs1_nao.csr`, `hrs2_nao.csr` (nspin=2), and `sr_nao.csr` files. For older versions, they are in `data-HR-*` and `data-SR-*` files.
