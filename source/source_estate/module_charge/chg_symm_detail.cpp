...
{
    ModuleBase::TITLE("module_charge","rhog_piece_to_all");
...
void psymmg(std::complex<double>* rhog_part, const ModulePW::PW_Basis *rho_basis, ModuleSymmetry::Symmetry &symm)
{
    ...
    reduce_to_fullrhog(rho_basis, rhogtot, rhog_part, ig2isztot, rho_basis->ig2isz, max_npw);
...
#ifdef __MPI
        get_ixyz2ipw(rho_basis, ig2isztot, fftixy2is, ixyz2ipw);
...
#else
        get_ixyz2ipw(rho_basis, rho_basis->ig2isz, fftixy2is, ixyz2ipw);
...
void psymmg_soc(std::complex<double>* rhog_x, std::complex<double>* rhog_y,
    std::complex<double>* rhog_z, const ModulePW::PW_Basis* rho_basis, ModuleSymmetry::Symmetry& symm)
{
    ...
    reduce_to_fullrhog(rho_basis, rhogtot_x, rhog_x, ig2isztot, rho_basis->ig2isz, max_npw);
    reduce_to_fullrhog(rho_basis, rhogtot_y, rhog_y, ig2isztot, rho_basis->ig2isz, max_npw);
    reduce_to_fullrhog(rho_basis, rhogtot_z, rhog_z, ig2isztot, rho_basis->ig2isz, max_npw);
