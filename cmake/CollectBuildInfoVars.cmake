...
if(BUILD_TESTING)
    ...
    set(ABACUS_TESTING "ON")
else()
    set(ABACUS_GTEST_VERSION "no")
    set(ABACUS_TESTING "OFF")
endif()

if(ENABLE_GOOGLEBENCH)
    set(ABACUS_GOOGLEBENCH_VERSION "Enabled")
else()
...
message(" -------------------------------------------------------------------")
message(" Build Testing     : ${ABACUS_TESTING}")
if(BUILD_TESTING)
  message(" GoogleBench       : ${ABACUS_GOOGLEBENCH_VERSION}")
endif()
message(" ===================================================================")
